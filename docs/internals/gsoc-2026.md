---
description: Google Summer of Code 2026 project ideas for Metaflow
---

# GSoC 2026 Ideas

All the mentors can be contacted on the [community Slack](http://slack.outerbounds.co/)
in the **#gsoc** channel. Please post all GSoC-related questions and discussions
there rather than in other channels.

**New to Metaflow GSoC?** Start with the
[contributor guide](/internals/gsoc-2026-contributor-guide) — it covers how to
introduce yourself, what we look for in applications, a proposal template, and
what to expect during the program. Reading it before posting in #gsoc will
help you make a strong first impression.

To contact specific mentors, you can tag them in threads within #gsoc:
...
The [Metaflow Dev Stack](/getting-started/devstack)
...
Tests should be executed using Metaflow's [Runner](/metaflow/managing-flows/runner)
and [Deployer](/metaflow/managing-flows/deployer) APIs,
